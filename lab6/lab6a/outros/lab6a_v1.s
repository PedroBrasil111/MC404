...
atoi:
    ...
    1:
        ...
        mul s0, s0, t1 # multiply result by 10
        add s0, s0, t2 # add digit
...
_start:
    jal read
    li a0, 0 # counter
    li t1, 4 # loop end condition
    1:
        beq a0, t1, 1f; # if a0 == t1 then done
        jal atoi
        jal babylonian_sqrt
        jal itoa
        addi a0, a0, 1
